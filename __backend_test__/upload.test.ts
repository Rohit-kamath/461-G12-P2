...
describe('reset', () => {
  it('should return 200 status code to signifiy successful reset', async () => {
    try{
      const response = await axios.delete('http://ece461-packageregistry-depenv.eba-bphpcw3d.us-east-2.elasticbeanstalk.com/reset');
...
describe('upload', () => {
  it('should return 200 status code and something for a valid github repo link', async () => {
    try{
      const response = await axios.post('http://ece461-packageregistry-depenv.eba-bphpcw3d.us-east-2.elasticbeanstalk.com/package', {
  ...
  it('should return 409 status code to indicate package already exists', async () => {
    try{
      await axios.post('http://ece461-packageregistry-depenv.eba-bphpcw3d.us-east-2.elasticbeanstalk.com/package', {
      "URL": "https://github.com/feross/safe-buffer",
      "JSProgram": "if (process.argv.length === 7) {\nconsole.log('Success')\nprocess.exit(0)\n} else {\nconsole.log('Failed')\nprocess.exit(1)\n}\n"
      });
    ...
    it('should return 200 status code and something for a valid base64 zip upload', async () => {
      ...
      it('should return 409 status code to indicate package already exists', async () => {
        ...
        it('should return 200 status code and something for a valid npm link', async () => {
          try{
            const response = await axios.post('http://ece461-packageregistry-depenv.eba-bphpcw3d.us-east-2.elasticbeanstalk.com/package', {
            "URL": "https://www.npmjs.com/package/hash.js",
            "JSProgram": "if (process.argv.length === 7) {\nconsole.log('Success')\nprocess.exit(0)\n} else {\nconsole.log('Failed')\nprocess.exit(1)\n}\n"
            });
              expect(response.status).toBe(200);
            }catch(error:any){
